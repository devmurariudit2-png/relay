              ...
              {mode !== "forgot" && (
                <>
                  <div className="relative flex items-center w-full">
                    ...
                    <span className="flex-shrink-0 mx-4 text-gray-400 text-[12px] font-medium uppercase tracking-wider">or</span>
                    <div className="flex-grow border-t border-gray-200"></div>
                  </div>
                  <button
                    type="button"
                    onClick={loginWithGoogle}
                    className="w-full bg-white border border-gray-200 hover:bg-gray-50 hover:border-gray-300 text-gray-700 font-semibold rounded-lg py-3 px-4 text-[14px] cursor-pointer transition-all shadow-sm flex justify-center items-center gap-3 h-[48px]"
                    disabled={loading}
                  >
                    ...
                    <span className="ml-1 text-[11px] font-normal text-gray-400">(Phase 2)</span>
                  </button>
                </>
              )}
